  ...
  return (
    <div className="skills-section py-10 h-[100vh] w-full bg-black overflow-hidden">
      <div className="container icons  ">
        <h2 className="text-4xl font-bold mb-8 pl-20">My Skills</h2>
        <div className="skills-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pl-32 ">
          {skills.map((skill, index) => (
            <div key={index} className="skill-card flex items-center p-4 border-2 rounded-lg border-none hover:bg-gray-600 duration-300 hover:scale-105 ">
              {skill.icon}
      ...
      <div className="container moving flex pt-5  z-10 ">
      ...
      <div className="container_bottom flex justify-between pt-10 px-10 pl-20 pr-20 ">
        <div className=" left flex "><h1 className="flex flex-col justify-center items-center text-[2vw]">10+<span className="font-extrabold bg-gradient-to-t from-blue-500 to-red-500 text-transparent bg-clip-text">Projects</span></h1></div>
        <div className="h-18 w-[1px] bg-gray-400"></div>
        <div className=" center flex"><h1 className="flex flex-col justify-center items-center text-[2vw]">10+<span className="font-extrabold bg-gradient-to-t from-blue-500 to-red-500 text-transparent bg-clip-text">Projects</span></h1></div>
        <div className="h-18 w-[1px] bg-gray-400"></div>
        <div className=" right flex "><h1 className="flex flex-col justify-center items-center text-[2vw] ">10+<span className="font-extrabold bg-gradient-to-t from-blue-500 to-red-500 text-transparent bg-clip-text">Projects</span></h1></div>
      </div>
    </div>
  );
};
