  ...
  return (
    <>
       <div className="relative w-full h-screen bg-black -z-20 overflow-hidden">
        ...
        <div className="icons relative w-full h-screen">
      {/* Social Media Links */}
      <div className="fixed right-4 top-1/2 transform -translate-y-1/2 z-50 flex flex-col gap-6 p-4">
        {/* GitHub */}
        <a
      ...
      <div className="home-left-content flex flex-col justify-center h-screen">
